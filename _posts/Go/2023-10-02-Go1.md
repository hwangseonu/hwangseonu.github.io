...
하지만 Go언어를 다른사람에게 설명하라 했을 때 과연 자신있게 설명할 수 있을까 고민해보았다.  

내가 Go언어에 대해 잘 알고 있다고 말하려면  
다른 사람들에게 자신있게 설명할 수 있어야 하지 않겠는가.
...
Go의 개발자 중 *켄 톰슨* C언어의 아버지 라고 불린다.  
...
당여히 구글도 사용하고 있으며, 드롭박스, 클라우드플레어, 트위치 등에서도 Go언어를 사용하고 있다고 하며  
